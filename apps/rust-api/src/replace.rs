// This will take in a struct of keywords (KWInstance), and replace the placeholder in the resume input with suitable keyword.
...
impl Replace {
    ...
    pub fn replace_keywords(&self) -> String {
        ...
        for (_canonical, instance) in self.keywords.keywords.iter() {
